...
{
    try{
        QPadrao_M = new QuadroResposta(NEWTON_PADRAO_DER_CALC, coeficientes, epsilon, lambda);
        QPadrao_H = new QuadroResposta(NEWTON_PADRAO_DER_NCALC, coeficientes, epsilon, lambda);
        QFL_M = new QuadroResposta(NEWTON_COM_FL_DER_CALC, coeficientes, epsilon, lambda);
        QFL_H = new QuadroResposta(NEWTON_COM_FL_DER_NCALC, coeficientes, epsilon, lambda);
    ...
    nomes_prop = {"x", "f(x)", "Err x", "Err f(x)", "Convergiu", "Rompimento"};
}
